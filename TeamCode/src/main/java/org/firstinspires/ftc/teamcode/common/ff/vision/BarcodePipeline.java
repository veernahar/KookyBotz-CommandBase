package org.firstinspires.ftc.teamcode.common.ff.vision;
...
public class BarcodePipeline extends OpenCvPipeline {
    ...
    public static Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(0, 115);
    public static Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(147, 115);
    public static Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(300, 115);
