 ...
 * @see Path
 */
public class MoveUntilIntakeCommand extends CommandBase {
    ...
    public MoveUntilIntakeCommand(MecanumDrive drivetrain, OdometrySubsystem odometrySubsystem, IntakeSubsystem intakeSubsystem,
                                  Pose2d targetPose, long millis, Pose2d divisorPose, double maxPowerDouble) {
        target = targetPose;
        drive = drivetrain;
    ...
    public boolean isFinished() {
        return intake.hasFreight() || timer.done();
    }
